...
const Page: FC = (): JSX.Element => {
    ...
    return (
        <section>
        <div className={`p-8 text-center`}>Семь основных энергетических центров - чакр:</div>
        ...
        <div className={`flex flex-col flex-start items-stretch p-8 gap-10`}>
            {info && info.map((elem) =>
                <div className={`flex flex-col gap-2 justify-evenly items-start`} data-info={elem} key={elem._id}>
                    <div className={`self-center`}>{elem.sound}</div>
